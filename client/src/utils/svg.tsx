...
export const JobTrackerLogo = () => {
    return (
        <svg style={{ paddingTop: '5px', paddingBottom: '5px', maxHeight: '200px'}} width="46" height="47" viewBox="0 0 46 47" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ProfileLogo = ({dark}:{dark: boolean}) => {
    
    const strokeColor = dark ? "#FFFF" : "#0F0F0F";
    return (
        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7 11.25H5C2.58 11.25 1.25 9.92 1.25 7.5V5.5C1.25 3.08 2.58 1.75 5 1.75H7C9.42 1.75 10.75 3.08 10.75 5.5V7.5C10.75 9.92 9.42 11.25 7 11.25ZM5 3.25C3.42 3.25 2.75 3.92 2.75 5.5V7.5C2.75 9.08 3.42 9.75 5 9.75H7C8.58 9.75 9.25 9.08 9.25 7.5V5.5C9.25 3.92 8.58 3.25 7 3.25H5Z" fill={strokeColor} />
            <path d="M19 11.25H17C14.58 11.25 13.25 9.92 13.25 7.5V5.5C13.25 3.08 14.58 1.75 17 1.75H19C21.42 1.75 22.75 3.08 22.75 5.5V7.5C22.75 9.92 21.42 11.25 19 11.25ZM17 3.25C15.42 3.25 14.75 3.92 14.75 5.5V7.5C14.75 9.08 15.42 9.75 17 9.75H19C20.58 9.75 21.25 9.08 21.25 7.5V5.5C21.25 3.92 20.58 3.25 19 3.25H17Z" fill={strokeColor} />
            <path d="M19 23.25H17C14.58 23.25 13.25 21.92 13.25 19.5V17.5C13.25 15.08 14.58 13.75 17 13.75H19C21.42 13.75 22.75 15.08 22.75 17.5V19.5C22.75 21.92 21.42 23.25 19 23.25ZM17 15.25C15.42 15.25 14.75 15.92 14.75 17.5V19.5C14.75 21.08 15.42 21.75 17 21.75H19C20.58 21.75 21.25 21.08 21.25 19.5V17.5C21.25 15.92 20.58 15.25 19 15.25H17Z" fill={strokeColor} />
            <path d="M7 23.25H5C2.58 23.25 1.25 21.92 1.25 19.5V17.5C1.25 15.08 2.58 13.75 5 13.75H7C9.42 13.75 10.75 15.08 10.75 17.5V19.5C10.75 21.92 9.42 23.25 7 23.25ZM5 15.25C3.42 15.25 2.75 15.92 2.75 17.5V19.5C2.75 21.08 3.42 21.75 5 21.75H7C8.58 21.75 9.25 21.08 9.25 19.5V17.5C9.25 15.92 8.58 15.25 7 15.25H5Z" fill={strokeColor} />
        </svg>
    )
}

export const CvFilesLogo = ({dark}:{dark: boolean}) => {
    
    const strokeColor = dark ? "#FFFF" : "#0F0F0F";
    return (
        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 23.25H9C3.57 23.25 1.25 20.93 1.25 15.5V9.5C1.25 4.07 3.57 1.75 9 1.75H14C14.41 1.75 14.75 2.09 14.75 2.5C14.75 2.91 14.41 3.25 14 3.25H9C4.39 3.25 2.75 4.89 2.75 9.5V15.5C2.75 20.11 4.39 21.75 9 21.75H15C19.61 21.75 21.25 20.11 21.25 15.5V10.5C21.25 10.09 21.59 9.75 22 9.75C22.41 9.75 22.75 10.09 22.75 10.5V15.5C22.75 20.93 20.43 23.25 15 23.25Z" fill={strokeColor} />
            <path d="M22 11.25H18C14.58 11.25 13.25 9.92 13.25 6.5V2.5C13.25 2.2 13.43 1.92 13.71 1.81C13.99 1.69 14.31 1.76 14.53 1.97L22.53 9.97C22.74 10.18 22.81 10.51 22.69 10.79C22.57 11.07 22.3 11.25 22 11.25ZM14.75 4.31V6.5C14.75 9.08 15.42 9.75 18 9.75H20.19L14.75 4.31Z" fill={strokeColor} />
            <path d="M13 14.25H7C6.59 14.25 6.25 13.91 6.25 13.5C6.25 13.09 6.59 12.75 7 12.75H13C13.41 12.75 13.75 13.09 13.75 13.5C13.75 13.91 13.41 14.25 13 14.25Z" fill={strokeColor} />
            <path d="M11 18.25H7C6.59 18.25 6.25 17.91 6.25 17.5C6.25 17.09 6.59 16.75 7 16.75H11C11.41 16.75 11.75 17.09 11.75 17.5C11.75 17.91 11.41 18.25 11 18.25Z" fill={strokeColor} />
        </svg>
    )
}
export const ApplicationsLogo = ({dark}:{dark: boolean}) => {
    
    const strokeColor = dark ? "#FFFF" : "#0F0F0F";
    return (
        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.27 23.25H4.23C2.22 23.25 1.25 22.32 1.25 20.4V4.6C1.25 2.68 2.23 1.75 4.23 1.75H8.27C10.28 1.75 11.25 2.68 11.25 4.6V20.4C11.25 22.32 10.27 23.25 8.27 23.25ZM4.23 3.25C2.96 3.25 2.75 3.59 2.75 4.6V20.4C2.75 21.41 2.96 21.75 4.23 21.75H8.27C9.54 21.75 9.75 21.41 9.75 20.4V4.6C9.75 3.59 9.54 3.25 8.27 3.25H4.23Z" fill={strokeColor} />
            <path d="M19.77 14.25H15.73C13.72 14.25 12.75 13.32 12.75 11.4V4.6C12.75 2.68 13.73 1.75 15.73 1.75H19.77C21.78 1.75 22.75 2.68 22.75 4.6V11.4C22.75 13.32 21.77 14.25 19.77 14.25ZM15.73 3.25C14.46 3.25 14.25 3.59 14.25 4.6V11.4C14.25 12.41 14.46 12.75 15.73 12.75H19.77C21.04 12.75 21.25 12.41 21.25 11.4V4.6C21.25 3.59 21.04 3.25 19.77 3.25H15.73Z" fill={strokeColor} />
            <path d="M19.77 23.25H15.73C13.72 23.25 12.75 22.32 12.75 20.4V18.6C12.75 16.68 13.73 15.75 15.73 15.75H19.77C21.78 15.75 22.75 16.68 22.75 18.6V20.4C22.75 22.32 21.77 23.25 19.77 23.25ZM15.73 17.25C14.46 17.25 14.25 17.59 14.25 18.6V20.4C14.25 21.41 14.46 21.75 15.73 21.75H19.77C21.04 21.75 21.25 21.41 21.25 20.4V18.6C21.25 17.59 21.04 17.25 19.77 17.25H15.73Z" fill={strokeColor} />
        </svg>
    )
}
export const SpontaneousLogo = ({dark}:{dark: boolean}) => {
    
    const strokeColor = dark ? "#FFFF" : "#0F0F0F";
    return (
        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M21 5.75H3C2.59 5.75 2.25 5.41 2.25 5C2.25 4.59 2.59 4.25 3 4.25H21C21.41 4.25 21.75 4.59 21.75 5C21.75 5.41 21.41 5.75 21 5.75Z" fill={strokeColor} />
            <path d="M12.47 10.75H3C2.59 10.75 2.25 10.41 2.25 10C2.25 9.59 2.59 9.25 3 9.25H12.47C12.88 9.25 13.22 9.59 13.22 10C13.22 10.41 12.89 10.75 12.47 10.75Z" fill={strokeColor} />
            <path d="M21 15.75H3C2.59 15.75 2.25 15.41 2.25 15C2.25 14.59 2.59 14.25 3 14.25H21C21.41 14.25 21.75 14.59 21.75 15C21.75 15.41 21.41 15.75 21 15.75Z" fill={strokeColor} />
            <path d="M12.47 20.75H3C2.59 20.75 2.25 20.41 2.25 20C2.25 19.59 2.59 19.25 3 19.25H12.47C12.88 19.25 13.22 19.59 13.22 20C13.22 20.41 12.89 20.75 12.47 20.75Z" fill={strokeColor} />
        </svg>
    )
}
...
export const EditIcon = ({dark}:{dark: boolean}) => {
