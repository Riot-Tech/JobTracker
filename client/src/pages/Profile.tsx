    ...
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <div className="flex flex-col justify-between h-full w-full">
        ...
        <div className={`relative flex flex-col w-full h-full items-center bg-custom-backLight dark:bg-custom-backDark overflow-y-auto`}>
          ...
          <div className="flex rounded-xl mt-28 md:flex-row flex-col items-center justify-center margin-auto text-black dark:text-white">
            {/* User and links icons */}

            <div className="flex flex-col items-center drop-shadow-lg w-full">
              <h1 className={`${isMobile ? 'text-4xl' : 'text-6xl'} drop-shadow-xl font-semibold`}>
                {activeUser.name
                  .split(' ')
              ...
              <div className="flex flex-row items-center justify-center py-2">
                ...
                <div className="flex items-center mt-10 space-x-4 justify-center bg-gray-100 p-3 pl-6 pr-6 rounded-3xl drop-shadow-xl shadow-xl dark:bg-gray-200">
                  {/* linkedin */}
                  {input.linkedIn ? (
            ...
            {isEditing && (
              <div className="flex items-center">
                ...
                <div className="">
                  <AiOutlineClose onClick={handleClose} className='text-3xl p-1 text-white bg-gray-600 rounded-2xl ml-2 hover: cursor-pointer hover:bg-black dark:bg-white dark:text-black dark:hover:bg-black dark:hover:text-white' />
                </div>
              </div>
            )}
          </div>
          ...
          <div className={`flex justify-between items-center mt-12 ${isMobile ? 'w-[90%] flex-col' : 'w-[70%]'} margin-auto mt-2`}>
            ...
            <div className="flex flex-col justify-between mb-8 md:mb-1 items-center hover:scale-105 transition-transform">
              <div className="relative">
                ...
                />
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-4xl md:text-7xl font-bold">
                  {files.filesCopy.length}
                </div>
              </div>
              <div className="flex justify-center">
                <h2 className={`font-bold text-3xl mt-4 dark:text-white drop-shadow-xl tracking-wide`}>
                  Files
                </h2>
              </div>
            </div>

            <div className="flex flex-col justify-center mb-8 md:mb-1 items-center hover:scale-105 transition-transform">
              <div className="relative">
                <img
                  className={` ${isMobile ? 'w-20' : 'w-40'}`}
                  src={hexagon}
              ...
              <div className="flex justify-center">
                <h2 className="font-bold text-3xl mt-4 dark:text-white tracking-wide">
                  Applications
                </h2>
              </div>
            </div>
