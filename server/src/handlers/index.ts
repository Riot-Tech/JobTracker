...
//Sing Up
export { signUpHandler } from './SignUpHandlers/signUpHandler';

//Auth
export { authenticationHandler } from './AuthenthicationHandlers/authenthicationHandler';

//User
export { getUserByIdHandler }  from './UserHandlers/getUserByIdHandler';
export { postUserHandler } from './UserHandlers/postUserHandler';
...
//Files
export { getFilesHandler } from './FileHandlers/getFilesHandler'
