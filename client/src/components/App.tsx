...
export default function App({ props }: { props: Application }) {
  ...
  return (
    <div className="p-5 rounded-xl my-4 mt-4 mb-4 bg-gray-300 w-full flex flex-col justify-between shadow-xl border-2 dark:bg-gray-400 hover:scale-105 transition-transform">
